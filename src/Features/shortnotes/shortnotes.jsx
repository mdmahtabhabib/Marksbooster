...
function Section({ section }) {
  return(
    <section>
      <div className={section.type=== "sub" ? "mb-[8px] mt - [16px] break-inside-avoid text-[13px] font-bold uppercase tracking-[0.06em] text-slate-500 " : "mb-[10px] mt-[16px] break-inside-avoid border-l-[3px] border-[#0e5490] pl-[8px] text-[14px] font-bold uppercasse tracking-[0.08em] text-[#0e5490] "}  >
       {section.title}
      </div>
